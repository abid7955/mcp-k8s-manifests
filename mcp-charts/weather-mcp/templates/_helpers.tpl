...
helm.sh/chart: {{ include "weather-mcp.chart" . }}
{{ include "weather-mcp.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "weather-mcp.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "weather-mcp.fullname" .) .Values.serviceAccount.name }}
{{- else }}
